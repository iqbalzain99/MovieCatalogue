...
class ShowRepository private constructor(
    ...
    private val localDataSource: LocalDataSource) : ShowDataSource{

    companion object {
        @Volatile
        private var instance: ShowRepository? = null

        fun getInstance(remoteData: RemoteDataSource, localData: LocalDataSource): ShowRepository =
            instance ?: synchronized(this) {
                instance ?: ShowRepository(remoteData, localData).apply { instance = this }
            }
    }
