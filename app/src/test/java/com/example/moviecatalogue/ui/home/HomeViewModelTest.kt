...
class HomeViewModelTest {
    ...
    fun getMovies() {
        ...
        Mockito.`when`(showRepository.getListMovie()).thenReturn(movie)
        viewModel.getMovies()
        val movieEntities  = viewModel.movie
        Mockito.verify(showRepository).getListMovie()
    ...
    fun testGetMovies() {
        ...
        Mockito.`when`(showRepository.getListMovie("venom")).thenReturn(movie)
        viewModel.getMovies("venom")
        val movieEntities  = viewModel.movie
        Mockito.verify(showRepository).getListMovie("venom")
        assertNotNull(movieEntities)
        assertEquals(movie, movieEntities)
        assertNotNull(movie.value)
        assertEquals(movie.value, movieEntities.value)
    ...
    fun getTvShow() {
        ...
        Mockito.`when`(showRepository.getListTv()).thenReturn(tv)
        viewModel.getTvShow()
        val tvEntities  = viewModel.tv
        Mockito.verify(showRepository).getListTv()
    ...
    fun testGetTvShow() {
        ...
        Mockito.`when`(showRepository.getListTv("siregar")).thenReturn(tv)
        viewModel.getTvShow("siregar")
        val tvEntities  = viewModel.tv
        Mockito.verify(showRepository).getListTv("siregar")
        assertNotNull(tvEntities)
        assertEquals(tv, tvEntities)
        assertNotNull(tv.value)
        assertEquals(tv.value, tvEntities.value)
